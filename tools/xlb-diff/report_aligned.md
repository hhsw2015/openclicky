...
[FAIL] A4: exact "Deep Learning" (overlap 5%)
[FAIL] A5: exact "MCP" (overlap 50%)
[FAIL] A6: substring "vibe cod" (overlap 33%)
[FAIL] A7: substring "deep lea" (overlap 0%)
...
[FAIL] B5: fuzzy ??paper (overlap 14%)
...
2026-08-02 19:23:54.944 xlb-diff[40268:1489972] [XLBTopicIndex] graphCommunity(Louvain) converged in 21 pass iteration(s), Q=0.8576, 46 clusters (>= 2), 0.780s
...
### A4: exact "Deep Learning" (overlap 5%)
...
- Missing in Swift: {cs224n natural language processing with deep learning 2023, cs230 deep learning autumn 2018, cs230 deep learning i autumn 2025, cs231n deep learning for computer vision i 2025, cs330 deep multi-task and meta learning, cs330 deep multi-task and meta learning autumn 2020, cs330 deep multi-task and meta learning i autumn 2022, deep learning framework, deep reinforcement learning}
- Extra in Swift: {cmu deep learning, deep learning for games, deep learning for natural language processing, deep learning indaba, deep learning lecture series 2020 deepmind x ucl, deep learning summer school, deep learning weekly, github deep learning, nvidia deep learning institute}
...
### A7: substring "deep lea" (overlap 0%)
- Swift: {cmu deep learning, deep learning, deep learning for games, deep learning for natural language processing, deep learning indaba, deep learning lecture series 2020 deepmind x ucl, deep learning summer school, deep learning weekly, github deep learning, nvidia deep learning institute}
...
- Missing in Swift: {cs224n natural language processing with deep learning 2023, cs230 deep learning autumn 2018, cs230 deep learning i autumn 2025, cs231n deep learning for computer vision i 2025, cs330 deep multi-task and meta learning, cs330 deep multi-task and meta learning autumn 2020, cs330 deep multi-task and meta learning i autumn 2022, deep learning and generative models course, deep learning framework, deep reinforcement learning}
- Extra in Swift: {cmu deep learning, deep learning, deep learning for games, deep learning for natural language processing, deep learning indaba, deep learning lecture series 2020 deepmind x ucl, deep learning summer school, deep learning weekly, github deep learning, nvidia deep learning institute}
...
- Missing in Swift: {3d model, cesm community earth system model, chaos model, cs236 deep generative models i 2023 i stefano ermon, model synthesis}
...
- Missing in Swift: {autonomous driving, awesome.paper, how to finding papers, how to read paper, how to trace paper, how to write paper, ingo wald paper, livestreams on ml papers coding research, mark papermaster, paper, paper explaine & ??papers explaine & ??paper-reading, paper source, papers slop, wallpaper engine/live wallpaper/动态壁纸/美化, 壁纸/wallpaper}
- Extra in Swift: {ai papers, paper explain/summarize, paper explaine, paper list, paper to webpage, papers, papers analytics, papers explaine/论文精读, papers for, paperwebsite, paperweekly, paper翻译, readpaper, rl papers, wallpaper}
