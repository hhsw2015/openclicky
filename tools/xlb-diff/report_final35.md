...
[PASS] A1: exact "AI Model" (overlap 100%)
[PASS] A2: exact "Vibe Coding" (overlap 100%)
[PASS] A3: exact "Awesome Search" (overlap 90%)
[PASS] A4: exact "Deep Learning" (overlap 100%)
[PASS] A5: exact "MCP" (overlap 100%)
[PASS] A6: substring "vibe cod" (overlap 100%)
[PASS] A7: substring "deep lea" (overlap 100%)
[PASS] A8: substring "awesome" (overlap 90%)
[PASS] A9: substring "model" (overlap 100%)
[PASS] A10: substring "docker" (overlap 100%)
[PASS] B1: fuzzy ??vibe (overlap 100%)
[PASS] B2: fuzzy ??deep learning (overlap 95%)
[PASS] B3: fuzzy ??cursor (overlap 100%)
[PASS] B4: fuzzy ??rust (overlap 100%)
[PASS] B5: fuzzy ??paper (overlap 100%)
[PASS] C1: path Vibe Coding -> AI (overlap 100%)
[PASS] C2: path Vibe Coding -> LLM (overlap 100%)
