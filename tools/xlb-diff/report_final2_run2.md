...
2026-08-02 17:42:05.853 xlb-diff[77525:1286296] [XLBTopicIndex] graphCommunity(Louvain) converged in 21 pass iteration(s), Q=0.8576, 46 clusters (>= 2), 0.768s
...
[FAIL] G3: meta Deep Learning (overlap 71%)
...
### G3: meta Deep Learning (overlap 71%)
- Swift: {alias, blog, conference, crossref, facebook, medium, path, people, reddit, survey, website, weixin, y-channel, youtube, z-zhihu}
...
- Missing in Swift: {alternativeto, baiduyun, command, douyu, fb-group, github, homepage, hugging_face, huggingface, juejin, paper, searchin, slack, soundcloud, twitter, y-channel2, y-playlist, zhihu}
- Extra in Swift: {crossref}
