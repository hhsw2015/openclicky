...
// Embedded-runtime patch: real `turndown` isn't bundled (would pull a
// 500 KB dependency in for a feature that pipeline-only adapters don't
// reach). Functions that build a TurndownService below throw at the
// call site; isRecord/mapConcurrent/sleep work fine without it.
